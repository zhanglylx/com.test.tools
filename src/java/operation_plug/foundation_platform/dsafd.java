package operation_plug.foundation_platform;
...
public class dsafd {
    ...
    public dsafd(long cpId, String title, String authorName, String lecturer, String introduction, String shortIntroduction, String lecturerIntroduction, String keyword, String cpAudioId, byte audioStatus, byte categoryId) {
        this.cpId = cpId;
        this.title = title;
